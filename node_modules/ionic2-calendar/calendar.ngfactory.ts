...
class View_CalendarComponent6 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_2:any = import3.inlineInterpolate(1,'',this.parentView.parentView.parentView.parentView.context.allDayLabel,'');
...
class View_CalendarComponent10 extends import2.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_0_0_1:any = (this.parentView.context.monthviewInactiveDisplayEventTemplate || (<View_CalendarComponent0>this.parentView)._TemplateRef_1_4);
    this._MonthViewComponent_0_3.check_monthviewInactiveDisplayEventTemplate(currVal_0_0_1,throwOnChange,false);
    const currVal_0_0_2:any = (this.parentView.context.monthviewEventDetailTemplate || (<View_CalendarComponent0>this.parentView)._TemplateRef_3_4);
    this._MonthViewComponent_0_3.check_monthviewEventDetailTemplate(currVal_0_0_2,throwOnChange,false);
    const currVal_0_0_3:any = this.parentView.context.formatDay;
    this._MonthViewComponent_0_3.check_formatDay(currVal_0_0_3,throwOnChange,false);
    const currVal_0_0_4:any = this.parentView.context.formatDayHeader;
    this._MonthViewComponent_0_3.check_formatDayHeader(currVal_0_0_4,throwOnChange,false);
    const currVal_0_0_5:any = this.parentView.context.formatMonthTitle;
    this._MonthViewComponent_0_3.check_formatMonthTitle(currVal_0_0_5,throwOnChange,false);
    const currVal_0_0_6:any = this.parentView.context.eventSource;
    this._MonthViewComponent_0_3.check_eventSource(currVal_0_0_6,throwOnChange,false);
    const currVal_0_0_7:any = this.parentView.context.startingDayMonth;
    this._MonthViewComponent_0_3.check_startingDayMonth(currVal_0_0_7,throwOnChange,false);
    const currVal_0_0_8:any = this.parentView.context.showEventDetail;
    this._MonthViewComponent_0_3.check_showEventDetail(currVal_0_0_8,throwOnChange,false);
    const currVal_0_0_9:any = this.parentView.context.noEventsLabel;
    this._MonthViewComponent_0_3.check_noEventsLabel(currVal_0_0_9,throwOnChange,false);
    const currVal_0_0_10:any = this.parentView.context.autoSelect;
    this._MonthViewComponent_0_3.check_autoSelect(currVal_0_0_10,throwOnChange,false);
    const currVal_0_0_11:any = this.parentView.context.markDisabled;
    this._MonthViewComponent_0_3.check_markDisabled(currVal_0_0_11,throwOnChange,false);
    const currVal_0_0_12:any = this.parentView.context.locale;
    this._MonthViewComponent_0_3.check_locale(currVal_0_0_12,throwOnChange,false);
